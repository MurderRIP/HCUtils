package rip.murderhcf.utils.packets;
...
public class SkinFixPacket {

    private static final String PROFILE_URL = "https://sessionserver.mojang.com/session/minecraft/profile/";
    private static final int WORKER_THREADS = 4;

    private final ProtocolManager protocolManager;
    private final ConcurrentMap<String, String> skinNames = Maps.newConcurrentMap();
    private final ConcurrentMap<String, String> displayNames = Maps.newConcurrentMap();

    private final Cache<String, String> profileCache = CacheBuilder.newBuilder().
            maximumSize(500).
    ...
    public SkinFixPacket(Plugin plugin) {
